    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img class="" src="{{ asset('backend/assets/img/team (1).jpg') }}" width="100px" height="60px" style="border-radius: 50%">
        </div>
      </a>
        ...
        <li class="nav-item">
          ...
          <div id="collapseCategory" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{ route('backend.category.create') }}">Add Category</a>
              <a class="collapse-item" href="{{ route('backend.category.index') }}">All Category</a>
            </div>
          </div>
        </li>
        <!-- Category end -->
      <!-- Portfolio Start -->
        <li class="nav-item">
          ...
          <div id="collapsePortfolio" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
